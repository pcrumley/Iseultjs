...
export const GET_UPDATED_CHARTS = 'views/GET_CHARTS_UPDATED'
...
export const MUTATE_CHART_TYPE = 'views/MUTATE_CHART_TYPE'
...
export const MUTATE_LASSO_REGION = 'simulation/MUTATE_LASSO_REGION'
...
export const CHANGE_CHART_TYPE = 'views/CHANGE_CHART_TYPE'
...
export const SET_CUR_VIEW = 'views/SET_CUR_VIEW'
export const GO_HOME = 'views/GO_HOME'
export const SET_LASSO_REGION = 'simulation/SET_LASSO_REGION'
export const DEL_LASSOES = 'sims/DEL_LASSOES'
export const IMG_SIZE_CHANGED = 'mainView/IMG_SIZE_CHANGED'
